        ...
        public static List<WishListLine> CreateWishListLines()
        {
            return new List<WishListLine>
            {
                new WishListLine
                {
                    ...
                    QtyOrdered = 1,
                    Pricing = new ProductPrice { UnitListPrice = 1, UnitNetPrice = 1 },
                    ProductId = new Guid(),
                    IsActive = true,
                    IsVisible = true
                },
                new WishListLine
                {
                    ...
                    QtyOrdered = 1,
                    Pricing = new ProductPrice { UnitListPrice = 4, UnitNetPrice = 5 },
                    ProductId = new Guid(),
                    IsActive = true,
                    IsVisible = true
                },
                new WishListLine
                {
                    ...
                    QtyOrdered = 1000,
                    Pricing = new ProductPrice { UnitListPrice = 10, UnitNetPrice = 9.14M },
                    ProductId = new Guid(),
                    IsActive = true,
                    IsVisible = true
                },
                new WishListLine
                {
                    ...
                    QtyOrdered = 2,
                    Pricing = new ProductPrice { UnitListPrice = 2, UnitNetPrice = 1 },
                    ProductId = new Guid(),
                    IsActive = true,
                    IsVisible = true
                }
            ...
            for (int i = start; i < end; i++)
            {
                ...
                wishlistLines.Add(
                    new WishListLine
                    {
                        ...
                        CustomerName = CreateShortDescription(
                            CommerceAPIConstants.CustomerName,
                            2,
                            preFix
                                + CommerceAPIConstants.CustomerNameUnique
                                + i.ToString()
                                + postFix
                        ),
